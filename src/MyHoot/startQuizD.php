...
<form id="form" action="getQuestion.php" onsubmit="return checkNumUsers()">
...
<div id="autoSub">Game starting in: <b id="timer">120</b> <b>seconds</b>.</div>
</div>
