function loadWaitingForUsers(ip,gameID){
    ...
    container.innerHTML =	'<div class="sqName" id="user_w_name_' + data.title + '" onClick="removeUser('  +data.title+')" style="background:#'+data.color +';">'+data.title+'</div>'   + ""+container.innerHTML;
